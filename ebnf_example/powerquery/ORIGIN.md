...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `powerquery`
- Source ref: `grammars-v4/powerquery`
...
Classic-BNF twin: `grammars-example/bnf_example/powerquery/`.
