...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `smalltalk`
- Source ref: `grammars-v4/smalltalk`
...
Classic-BNF twin: `grammars-example/bnf_example/smalltalk/`.
