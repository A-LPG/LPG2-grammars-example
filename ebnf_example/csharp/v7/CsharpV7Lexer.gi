-- CsharpV7 Lexer (LPG) — structural language subset
-- Not token-stream soup.

%Options list
%Options fp=CsharpV7Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.csharp.v7
%options template=LexerTemplateF.gi
%options filter=CsharpV7KWLexer.gi

%Define
    $kw_lexer_class /.$CsharpV7KWLexer./
%End
