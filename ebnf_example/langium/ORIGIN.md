...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `langium`
- Source ref: `grammars-v4/langium`
...
Classic-BNF twin: `grammars-example/bnf_example/langium/`.
