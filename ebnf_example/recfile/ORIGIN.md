...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `recfile`
- Source ref: `grammars-v4/recfile`
...
Classic-BNF twin: `grammars-example/bnf_example/recfile/`.
