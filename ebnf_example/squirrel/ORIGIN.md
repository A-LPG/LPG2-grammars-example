...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `squirrel`
- Source ref: `grammars-v4/squirrel`
...
Classic-BNF twin: `grammars-example/bnf_example/squirrel/`.
