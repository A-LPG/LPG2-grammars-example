...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `miniscript`
- Source ref: `grammars-v4/miniscript`
...
Classic-BNF twin: `grammars-example/bnf_example/miniscript/`.
