...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `angelscript`
- Source ref: `grammars-v4/angelscript`
...
Classic-BNF twin: `grammars-example/bnf_example/angelscript/`.
