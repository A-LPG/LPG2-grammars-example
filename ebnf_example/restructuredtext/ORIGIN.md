...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `restructuredtext`
- Source ref: `grammars-v4/restructuredtext`
...
Classic-BNF twin: `grammars-example/bnf_example/restructuredtext/`.
