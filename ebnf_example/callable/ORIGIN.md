...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `callable`
- Source ref: `grammars-v4/callable`
...
Classic-BNF twin: `grammars-example/bnf_example/callable/`.
