...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `calculator`
- Source ref: `grammars-v4/calculator`
...
Classic-BNF twin: `grammars-example/bnf_example/calculator/`.
