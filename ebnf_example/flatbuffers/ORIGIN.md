...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `flatbuffers`
- Source ref: `grammars-v4/flatbuffers`
...
Classic-BNF twin: `grammars-example/bnf_example/flatbuffers/`.
