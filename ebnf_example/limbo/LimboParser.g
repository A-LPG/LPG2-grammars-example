...
%Rules
    ...
    opt_5 ::= formal_arg_list?

    opt_6 ::= formal_arg_list?
    ...
    opt_11 ::= mod_member_list?

    list_12 ::= mod_member+

    opt_13 ::= adt_member_list?
    ...
    opt_34 ::= expression_list?

    seq_35 ::= OR qualifier

    list_36 ::= (list_36 seq_35)?
