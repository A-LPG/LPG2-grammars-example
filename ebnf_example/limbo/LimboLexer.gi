-- Real lexer for LimboParser (not token-stream soup). Keywords via LimboKWLexer.
%Options list
%Options fp=LimboLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.limbo
%options template=LexerTemplateF.gi
%options filter=LimboKWLexer.gi

%Define
    $kw_lexer_class /.$LimboKWLexer./
%End
