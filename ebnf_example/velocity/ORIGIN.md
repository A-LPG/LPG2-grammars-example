...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `velocity`
- Source ref: `grammars-v4/velocity`
...
Classic-BNF twin: `grammars-example/bnf_example/velocity/`.
