...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `bibcode`
- Source ref: `grammars-v4/bibcode`
...
Classic-BNF twin: `grammars-example/bnf_example/bibcode/`.
