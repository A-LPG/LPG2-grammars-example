...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `icalendar`
- Source ref: `grammars-v4/icalendar`
...
Classic-BNF twin: `grammars-example/bnf_example/icalendar/`.
