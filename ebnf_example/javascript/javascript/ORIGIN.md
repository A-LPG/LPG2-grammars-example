...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `javascript/javascript`
- Source ref: `grammars-v4/javascript/javascript`
...
Classic-BNF twin: `grammars-example/bnf_example/javascript/javascript/`.
