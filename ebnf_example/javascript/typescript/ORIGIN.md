...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `javascript/typescript`
- Source ref: `grammars-v4/javascript/typescript`
...
Classic-BNF twin: `grammars-example/bnf_example/javascript/typescript/`.
