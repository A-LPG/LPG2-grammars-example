...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `tinyos_nesc`
- Source ref: `grammars-v4/tinyos_nesc`
...
Classic-BNF twin: `grammars-example/bnf_example/tinyos_nesc/`.
