...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `python/python3`
- Source ref: `grammars-v4/python/python3`
...
Classic-BNF twin: `grammars-example/bnf_example/python/python3/`.
