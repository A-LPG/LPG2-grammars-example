...
%Rules
    ...
    grp_12 ::= arithmetic_component
              | arithmetic_expression

    grp_13 ::= arithmetic_component
              | arithmetic_expression
    ...
    grp_14 ::= set_variable
              | grp_15 ARROW relationship_spec
    ...
    grp_29 ::= FIND object_name
              | opt_30 set_variable

    grp_28 ::= grp_29 WHERE object_condition
    ...
    opt_64 ::= event_parameters?

    seq_65 ::= COMMA event_parameter

    list_66 ::= (list_66 seq_65)?

    opt_67 ::= output_parameter_list?

    opt_68 ::= input_parameter_list?

    opt_69 ::= output_parameter_list?

    opt_70 ::= input_parameter_list?

    opt_71 ::= output_parameter_list?

    opt_72 ::= input_parameter_list?
    ...
    list_83 ::= (list_83 statement)?

    list_84 ::= (list_84 statement)?
    ...
    list_97 ::= (list_97 grp_95)?

    grp_98 ::= variable
              | object_attribute

    list_99 ::= (list_99 statement)?
    ...
    list_134 ::= (list_134 statement)?

    list_135 ::= (list_135 statement)?
    ...
    grp_138 ::= BREAK
               | BREAKIF logical_condition

    list_139 ::= (list_139 statement)?

    grp_140 ::= break_statement
               | statement

    list_141 ::= (list_141 grp_140)?
