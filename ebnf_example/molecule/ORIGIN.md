...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `molecule`
- Source ref: `grammars-v4/molecule`
...
Classic-BNF twin: `grammars-example/bnf_example/molecule/`.
