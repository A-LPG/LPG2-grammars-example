...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `informix`
- Source ref: `grammars-v4/informix`
...
Classic-BNF twin: `grammars-example/bnf_example/informix/`.
