...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `corundum`
- Source ref: `grammars-v4/corundum`
...
Classic-BNF twin: `grammars-example/bnf_example/corundum/`.
