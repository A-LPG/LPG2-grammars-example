...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `robotwars`
- Source ref: `grammars-v4/robotwars`
...
Classic-BNF twin: `grammars-example/bnf_example/robotwars/`.
