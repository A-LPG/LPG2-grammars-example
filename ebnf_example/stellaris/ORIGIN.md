...
- Upstream: [antlr/grammars-v4](https://github.com/antlr/grammars-v4) `stellaris`
- Source ref: `grammars-v4/stellaris`
...
Classic-BNF twin: `grammars-example/bnf_example/stellaris/`.
