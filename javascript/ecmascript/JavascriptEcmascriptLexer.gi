-- Real lexer for JavascriptEcmascriptParser (not token-stream soup). Keywords via JavascriptEcmascriptKWLexer.
%Options list
%Options fp=JavascriptEcmascriptLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.javascript.ecmascript
%options template=LexerTemplateF.gi
%options filter=JavascriptEcmascriptKWLexer.gi

%Define
    $kw_lexer_class /.$JavascriptEcmascriptKWLexer./
%End
