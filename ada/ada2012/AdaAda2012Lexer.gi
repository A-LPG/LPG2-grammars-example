-- Real lexer for AdaAda2012Parser (not token-stream soup). Keywords via AdaAda2012KWLexer.
%Options list
%Options fp=AdaAda2012Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.ada.ada2012
%options template=LexerTemplateF.gi
%options filter=AdaAda2012KWLexer.gi

%Define
    $kw_lexer_class /.$AdaAda2012KWLexer./
%End
