-- Real lexer for AdaAda2022Parser (not token-stream soup). Keywords via AdaAda2022KWLexer.
%Options list
%Options fp=AdaAda2022Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.ada.ada2022
%options template=LexerTemplateF.gi
%options filter=AdaAda2022KWLexer.gi

%Define
    $kw_lexer_class /.$AdaAda2022KWLexer./
%End
