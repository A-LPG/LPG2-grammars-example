-- Real lexer for AdaAda83Parser (not token-stream soup). Keywords via AdaAda83KWLexer.
%Options list
%Options fp=AdaAda83Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.ada.ada83
%options template=LexerTemplateF.gi
%options filter=AdaAda83KWLexer.gi

%Define
    $kw_lexer_class /.$AdaAda83KWLexer./
%End
