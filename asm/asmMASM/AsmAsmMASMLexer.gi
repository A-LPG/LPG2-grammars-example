-- Real lexer for AsmAsmMASMParser (not token-stream soup). Keywords via AsmAsmMASMKWLexer.
%Options list
%Options fp=AsmAsmMASMLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.asm.asmMASM
%options template=LexerTemplateF.gi
%options filter=AsmAsmMASMKWLexer.gi

%Define
    $kw_lexer_class /.$AsmAsmMASMKWLexer./
%End
