-- Real lexer for AsmPdp7Parser (not token-stream soup). Keywords via AsmPdp7KWLexer.
%Options list
%Options fp=AsmPdp7Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.asm.pdp7
%options template=LexerTemplateF.gi
%options filter=AsmPdp7KWLexer.gi

%Define
    $kw_lexer_class /.$AsmPdp7KWLexer./
%End
