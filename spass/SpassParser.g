...
%Rules
    ...
    opt_20 ::= symbol_list | $empty

    opt_21 ::= declaration_list | $empty

    list_22 ::= $empty | list_22 formula_list

    list_23 ::= $empty | list_23 clause_list

    list_24 ::= $empty | list_24 proof_list

    grp_26 ::= fun_sym | LPAREN fun_sym COMMA arity RPAREN

    grp_28 ::= fun_sym | LPAREN fun_sym COMMA arity RPAREN
    ...
    grp_32 ::= pred_sym | LPAREN pred_sym COMMA arity RPAREN

    grp_34 ::= pred_sym | LPAREN pred_sym COMMA arity RPAREN

    grp_33 ::= COMMA grp_34

    list_35 ::= $empty | list_35 grp_33
    ...
    list_41 ::= $empty | list_41 declaration
    ...
    list_78 ::= setting_entry | list_78 setting_entry
