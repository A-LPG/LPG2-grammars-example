-- Real lexer for KqueryParser (not token-stream soup). Keywords via KqueryKWLexer.
%Options list
%Options fp=KqueryLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.kquery
%options template=LexerTemplateF.gi
%options filter=KqueryKWLexer.gi

%Define
    $kw_lexer_class /.$KqueryKWLexer./
%End
...
%Rules
    Token ::= width_type /. makeToken($_WidthType); ./
    ...
    width_type ::= 'w' width_digits
    width_digits ::= Digit | width_digits Digit
