...
%Rules
    ...
    list_6 ::= seq_5 | list_6 seq_5

    list_7 ::= $empty | list_7 pchar

    grp_8 ::= pchar | SLASH | QUESTION

    list_9 ::= $empty | list_9 grp_8

    list_10 ::= tchar | list_10 tchar

    grp_11 ::= field_content | obs_fold
    ...
    list_18 ::= $empty | list_18 grp_17

    grp_19 ::= SP | HTAB

    list_20 ::= grp_19 | list_20 grp_19
