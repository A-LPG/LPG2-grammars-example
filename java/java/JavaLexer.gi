-- Java Lexer (LPG) — curated subset with statements/expressions.
-- Full antlr/grammars-v4 java/java is much larger; examples are curated.
...
%Rules
    ...
    EscapeAny -> Letter | Digit | DoubleQuote | SingleQuote | BackSlash | Space | '/' | 'n' | 't' | 'r'
