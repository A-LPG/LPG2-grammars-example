-- Real lexer for AsmAsm8086Parser (not token-stream soup). Keywords via AsmAsm8086KWLexer.
%Options list
%Options fp=AsmAsm8086Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.asm.asm8086
%options template=LexerTemplateF.gi
%options filter=AsmAsm8086KWLexer.gi

%Define
    $kw_lexer_class /.$AsmAsm8086KWLexer./
%End
