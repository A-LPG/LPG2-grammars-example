-- Real lexer for SqlHiveV4Parser (not token-stream soup). Keywords via SqlHiveV4KWLexer.
%Options list
%Options fp=SqlHiveV4Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.sql.hive.v4
%options template=LexerTemplateF.gi
%options filter=SqlHiveV4KWLexer.gi

%Define
    $kw_lexer_class /.$SqlHiveV4KWLexer./
%End
