-- Real lexer for VhdlParser (not token-stream soup). Keywords via VhdlKWLexer.
%Options list
%Options fp=VhdlLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.vhdl.vhdl
%options template=LexerTemplateF.gi
%options filter=VhdlKWLexer.gi

%Define
    $kw_lexer_class /.$VhdlKWLexer./
%End
...
%Rules
    Token ::= identifier /. checkForKeyWord($_BASIC_IDENTIFIER); ./
