-- Real lexer for JavascriptJsxParser (not token-stream soup). Keywords via JavascriptJsxKWLexer.
%Options list
%Options fp=JavascriptJsxLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.javascript.jsx
%options template=LexerTemplateF.gi
%options filter=JavascriptJsxKWLexer.gi

%Define
    $kw_lexer_class /.$JavascriptJsxKWLexer./
%End
