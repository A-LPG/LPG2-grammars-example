-- Real lexer for AntlrAntlr4Parser (not token-stream soup). Keywords via AntlrAntlr4KWLexer.
%Options list
%Options fp=AntlrAntlr4Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.antlr.antlr4
%options template=LexerTemplateF.gi
%options filter=AntlrAntlr4KWLexer.gi

%Define
    $kw_lexer_class /.$AntlrAntlr4KWLexer./
%End
