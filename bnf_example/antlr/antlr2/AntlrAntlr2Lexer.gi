-- Real lexer for AntlrAntlr2Parser (not token-stream soup). Keywords via AntlrAntlr2KWLexer.
%Options list
%Options fp=AntlrAntlr2Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.antlr.antlr2
%options template=LexerTemplateF.gi
%options filter=AntlrAntlr2KWLexer.gi

%Define
    $kw_lexer_class /.$AntlrAntlr2KWLexer./
%End
