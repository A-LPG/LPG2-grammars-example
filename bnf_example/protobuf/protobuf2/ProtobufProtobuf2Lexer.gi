-- Real lexer for ProtobufProtobuf2Parser (not token-stream soup). Keywords via ProtobufProtobuf2KWLexer.
%Options list
%Options fp=ProtobufProtobuf2Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.protobuf.protobuf2
%options template=LexerTemplateF.gi
%options filter=ProtobufProtobuf2KWLexer.gi

%Define
    $kw_lexer_class /.$ProtobufProtobuf2KWLexer./
%End
