...
%Options la=3
%Options fp=Swift2Parser
%options package=lpg.grammars.swift.swift2
%options template=dtParserTemplateF.gi
%options import_terminals=Swift2Lexer.gi
...
%Rules
    ...
    for_in_statement ::= FOR pattern IN expression code_block
               ...
               | FOR pattern IN expression WHERE expression code_block
