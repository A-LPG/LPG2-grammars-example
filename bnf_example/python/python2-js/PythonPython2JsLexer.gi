-- Real lexer for PythonPython2JsParser (not token-stream soup). Keywords via PythonPython2JsKWLexer.
%Options list
%Options fp=PythonPython2JsLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.python.python2_js
%options template=LexerTemplateF.gi
%options filter=PythonPython2JsKWLexer.gi

%Define
    $kw_lexer_class /.$PythonPython2JsKWLexer./
%End
