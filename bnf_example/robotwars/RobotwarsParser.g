...
%Rules
    ...
    opt_content ::= $empty | label | comment | statement
    ...
    -- LALR layering of g4 expression (argument (operation argument)*)
    expression ::= unary
                 | expression operation unary
    operation ::= PLUS | MINUS | STAR | SLASH
