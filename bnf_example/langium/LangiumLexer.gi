-- Real lexer for LangiumParser (not token-stream soup). Keywords via LangiumKWLexer.
%Options list
%Options fp=LangiumLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.langium
%options template=LexerTemplateF.gi
%options filter=LangiumKWLexer.gi

%Define
    $kw_lexer_class /.$LangiumKWLexer./
%End
