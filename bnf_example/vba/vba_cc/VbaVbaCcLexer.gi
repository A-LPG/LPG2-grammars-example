-- Real lexer for VbaVbaCcParser (not token-stream soup). Keywords via VbaVbaCcKWLexer.
%Options list
%Options fp=VbaVbaCcLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.vba.vba_cc
%options template=LexerTemplateF.gi
%options filter=VbaVbaCcKWLexer.gi

%Define
    $kw_lexer_class /.$VbaVbaCcKWLexer./
%End
