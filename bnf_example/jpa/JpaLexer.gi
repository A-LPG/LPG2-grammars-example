-- Real lexer for JpaParser (not token-stream soup). Keywords via JpaKWLexer.
%Options list
%Options fp=JpaLexer
...
%options filter=JpaKWLexer.gi

%Define
    $kw_lexer_class /.$JpaKWLexer./
%End
...
%Rules
    Token ::= identifier /. checkForKeyWord($_IDENTIFICATION_VARIABLE); ./
            | number     /. makeToken($_NUMBER); ./
            | string     /. makeToken($_STRING); ./
            | LineComment /. skipToken(); ./
            | HashComment /. skipToken(); ./
            | white /. skipToken(); ./
            | 'C' 'U' 'R' 'R' 'E' 'N' 'T' '_' 'T' 'I' 'M' 'E' 'S' 'T' 'A' 'M' 'P' /. makeToken($_CURRENT_TIMESTAMP); ./
            | 'C' 'U' 'R' 'R' 'E' 'N' 'T' '_' 'D' 'A' 'T' 'E' /. makeToken($_CURRENT_DATE); ./
            | 'C' 'U' 'R' 'R' 'E' 'N' 'T' '_' 'T' 'I' 'M' 'E' /. makeToken($_CURRENT_TIME); ./
