-- Real lexer for PlucidParser (not token-stream soup). Keywords via PlucidKWLexer.
%Options list
%Options fp=PlucidLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.plucid
%options template=LexerTemplateF.gi
%options filter=PlucidKWLexer.gi

%Define
    $kw_lexer_class /.$PlucidKWLexer./
%End
