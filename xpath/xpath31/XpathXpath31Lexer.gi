-- Real lexer for XpathXpath31Parser (not token-stream soup). Keywords via XpathXpath31KWLexer.
%Options list
%Options fp=XpathXpath31Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.xpath.xpath31
%options template=LexerTemplateF.gi
%options filter=XpathXpath31KWLexer.gi

%Define
    $kw_lexer_class /.$XpathXpath31KWLexer./
%End
