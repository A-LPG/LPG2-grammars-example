...
%Rules
    ...
    typeParameterListInBrackets ::= OP_40818 typeParameterList OP_21850
           | OP_40818 typeParameterWithDefaultsList OP_21850
           | OP_40818 typeParameterList COMMA typeParameterWithDefaultsList OP_21850
    ...
    genericDynamicArgs ::= OP_40818 typeRef list_48 OP_21850
    ...
    expression ::= Clone expression
           ...
           | expression OP_28772 expression
           | grp_163 expression
           | grp_164 expression
           | Throw expression
    ...
    opt_16 ::= namespaceNameList
           | $empty

    list_17 ::= $empty
           | list_17 namespaceStatement

    grp_15 ::= opt_16 OpenCurlyBracket list_17 CloseCurlyBracket
    ...
    opt_20 ::= typeParameterListInBrackets
           | $empty
    ...
    opt_29 ::= typeParameterListInBrackets
           | $empty
    ...
    opt_34 ::= typeParameterListInBrackets
           | $empty
    ...
    grp_28 ::= classEntryType identifier opt_29 opt_31 opt_33
           | Interface identifier opt_34 opt_36

    list_37 ::= $empty
           | list_37 classStatement
    ...
    list_55 ::= $empty
           | list_55 innerStatement

    list_56 ::= $empty
           | list_56 elseIfStatement

    opt_57 ::= elseStatement
           | $empty

    list_58 ::= $empty
           | list_58 elseIfColonStatement

    opt_59 ::= elseColonStatement
           | $empty

    grp_60 ::= statement
           | COLON innerStatementList EndWhile SemiColon

    opt_61 ::= forInit
           | $empty

    opt_62 ::= expressionList
           | $empty
    ...
    grp_64 ::= statement
           | COLON innerStatementList EndFor SemiColon
    ...
    grp_65 ::= OpenCurlyBracket opt_66 list_67 CloseCurlyBracket
           | COLON opt_68 list_69 EndSwitch SemiColon

    grp_71 ::= Case expression
           | Default
    ...
    grp_77 ::= LPAREN expression As arrayDestructuring RPAREN
           | LPAREN chain As opt_78 assignable opt_81 RPAREN
           | LPAREN expression As assignable opt_84 RPAREN
           | LPAREN chain As List LPAREN assignmentList RPAREN RPAREN

    grp_85 ::= statement
           | COLON innerStatementList EndForeach SemiColon

    list_87 ::= catchClause
           | list_87 catchClause

    opt_88 ::= finallyStatement
           | $empty

    list_89 ::= $empty
           | list_89 catchClause

    grp_86 ::= list_87 opt_88
           | list_89 finallyStatement
    ...
    grp_93 ::= statement
           | COLON innerStatementList EndDeclare SemiColon
    ...
    grp_97 ::= numericConstant
           | Real

    opt_98 ::= formalParameter
           | $empty
    ...
    list_103 ::= $empty
           | list_103 memberModifier

    opt_104 ::= QuestionMark
           | $empty
    ...
    opt_123 ::= typeParameterListInBrackets
           | $empty

    grp_124 ::= baseCtorCall
           | returnTypeDecl

    opt_125 ::= grp_124
           | $empty

    grp_118 ::= Const opt_119 identifierInitializer list_121 SemiColon
           | Function_ opt_122 identifier opt_123 LPAREN formalParameterList RPAREN opt_125 methodBody

    grp_113 ::= propertyModifiers opt_114 variableInitializer list_116 SemiColon
           | opt_117 grp_118

    list_126 ::= $empty
           | list_126 traitAdaptationStatement

    opt_128 ::= memberModifier
           | $empty

    grp_127 ::= memberModifier
           | opt_128 identifier
    ...
    opt_132 ::= QuestionMark
           | $empty

    list_133 ::= memberModifier
           | list_133 memberModifier
    ...
    opt_169 ::= arrayItemList
           | $empty

    opt_170 ::= arrayItemList
           | $empty

    grp_168 ::= Array LPAREN opt_169 RPAREN
           | LBRACKET opt_170 RBRACKET
    ...
    opt_210 ::= genericDynamicArgs
           | $empty

    grp_211 ::= qualifiedNamespaceName
           | indirectTypeRef

    opt_212 ::= genericDynamicArgs
           | $empty
    ...
    opt_218 ::= typeParameterListInBrackets
           | $empty
    ...
    opt_223 ::= typeParameterListInBrackets
           | $empty
    ...
    grp_217 ::= classEntryType opt_218 opt_220 opt_222
           | Interface identifier opt_223 opt_225

    list_226 ::= $empty
           | list_226 classStatement
    ...
    grp_242 ::= actualArgument list_244
           | yieldExpression
    ...
    grp_262 ::= qualifiedStaticTypeRef
           | keyedVariable
           | string
    ...
    list_264 ::= HereDocText
           | list_264 HereDocText

    list_265 ::= HereDocText
           | list_265 HereDocText

    list_266 ::= $empty
           | list_266 interpolatedStringPart
    ...
    list_269 ::= $empty
           | list_269 memberAccess

    opt_270 ::= actualArguments
           | $empty

    opt_271 ::= genericDynamicArgs
           | $empty
    ...
    list_273 ::= $empty
           | list_273 squareCurlyExpression
    ...
    list_277 ::= $empty
           | list_277 squareCurlyExpression
    ...
    list_280 ::= $empty
           | list_280 squareCurlyExpression

    opt_281 ::= expression
           | $empty

    opt_282 ::= assignmentListElement
           | $empty

    opt_283 ::= assignmentListElement
           | $empty
