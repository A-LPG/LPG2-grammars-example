-- Sqlite Parser (LPG) — Wave D curated subset
%Options la=2
%Options fp=SqliteParser
%options package=lpg.grammars.sql.sqlite
%options template=dtParserTemplateF.gi
%options import_terminals=SqliteLexer.gi
...
%Rules
    ...
    table_ref ::= IDENTIFIER opt_alias
                | IDENTIFIER JOIN IDENTIFIER ON expr
                | IDENTIFIER LEFT JOIN IDENTIFIER ON expr
    ...
    type_name ::= INT | INTEGER | VARCHAR | TEXTTYPE | IDENTIFIER
