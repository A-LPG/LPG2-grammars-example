-- Keyword filter for SqlHiveV4 (from grammars-v4 lexer keywords + parser literals)
%options package=lpg.grammars.sql.hive.v4
%options template=KeywordTemplateF.gi
%options fp=SqlHiveV4KWLexer
...
%Rules
    ...
    Keyword ::= m a n a g e d l o c a t i o n /.$setResult($_KW_MANAGEDLOCATION);./
    ...
    Keyword ::= t r a n s a c t i o n a l /.$setResult($_KW_TRANSACTIONAL);./
    Keyword ::= v e c t o r i z a t i o n /.$setResult($_KW_VECTORIZATION);./
    Keyword ::= c o m p a c t i o n i d /.$setResult($_KW_COMPACT_ID);./
    Keyword ::= d b p r o p e r t i e s /.$setResult($_KW_DBPROPERTIES);./
    Keyword ::= d c p r o p e r t i e s /.$setResult($_KW_DCPROPERTIES);./
    ...
    Keyword ::= d i s t r i b u t e d /.$setResult($_KW_DISTRIBUTED);./
    ...
    Keyword ::= c o n n e c t o r s /.$setResult($_KW_DATACONNECTORS);./
    ...
    Keyword ::= c o n n e c t o r /.$setResult($_KW_DATACONNECTOR);./
    ...
    Keyword ::= s c h e d u l e d /.$setResult($_KW_SCHEDULED);./
    ...
    Keyword ::= e x e c u t e d /.$setResult($_KW_EXECUTED);./
    ...
    Keyword ::= j o i n c o s t /.$setResult($_KW_JOINCOST);./
    ...
    Keyword ::= t r a i l i n g /.$setResult($_KW_TRAILING);./
    ...
    Keyword ::= e x e c u t e /.$setResult($_KW_EXECUTE);./
    ...
    Keyword ::= l e a d i n g /.$setResult($_KW_LEADING);./
    Keyword ::= l o g i c a l /.$setResult($_KW_LOGICAL);./
    Keyword ::= m a n a g e d /.$setResult($_KW_MANAGED);./
    ...
    Keyword ::= p r e p a r e /.$setResult($_KW_PREPARE);./
    Keyword ::= p r i m a r y /.$setResult($_KW_PRIMARY);./
    Keyword ::= q u a l i f y /.$setResult($_KW_QUALIFY);./
    ...
    Keyword ::= r e s p e c t /.$setResult($_KW_RESPECT);./
    ...
    Keyword ::= u n k n o w n /.$setResult($_KW_UNKNOWN);./
    ...
    Keyword ::= i g n o r e /.$setResult($_KW_IGNORE);./
    ...
    Keyword ::= r e m o t e /.$setResult($_KW_REMOTE);./
    ...
    Keyword ::= w i t h i n /.$setResult($_KW_WITHIN);./
    ...
    Keyword ::= d e b u g /.$setResult($_KW_DEBUG);./
    ...
    Keyword ::= f o r c e /.$setResult($_KW_FORCE);./
    ...
    Keyword ::= a n t i /.$setResult($_KW_ANTI);./
    ...
    Keyword ::= c o s t /.$setResult($_KW_COST);./
    Keyword ::= c r o n /.$setResult($_KW_CRON);./
    ...
    Keyword ::= r e a l /.$setResult($_KW_REAL);./
    ...
    Keyword ::= a s t /.$setResult($_KW_AST);./
    Keyword ::= c b o /.$setResult($_KW_CBO);./
    Keyword ::= d d l /.$setResult($_KW_DDL);./
