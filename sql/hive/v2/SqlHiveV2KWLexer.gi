-- Keyword filter for SqlHiveV2 (from grammars-v4 lexer keywords + parser literals)
...
%Rules
    ...
    Keyword ::= u t c t i m e s t a m p /.$setResult($_KW_UTCTIMESTAMP);./
    ...
    Keyword ::= d o w /.$setResult($_KW_DOW);./
