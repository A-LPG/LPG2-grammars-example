-- Real lexer for SqlHiveV3Parser (not token-stream soup). Keywords via SqlHiveV3KWLexer.
%Options list
%Options fp=SqlHiveV3Lexer
%options single_productions
%options conflicts
%options package=lpg.grammars.sql.hive.v3
%options template=LexerTemplateF.gi
%options filter=SqlHiveV3KWLexer.gi

%Define
    $kw_lexer_class /.$SqlHiveV3KWLexer./
%End
