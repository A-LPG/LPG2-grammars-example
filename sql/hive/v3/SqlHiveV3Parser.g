-- AUTO-GENERATED from antlr/grammars-v4 sql/hive/v3 by tools/antlr2lpg.py
-- Structural port + LALR fixups (expression layering). Not token-stream soup.

%Options la=3
%Options fp=SqlHiveV3Parser
%options package=lpg.grammars.sql.hive.v3
%options template=dtParserTemplateF.gi
%options import_terminals=SqlHiveV3Lexer.gi
...
%Rules
    ...
    lateralView ::= KW_LATERAL KW_VIEW KW_OUTER function_ tableAlias opt_445
           | opt_446 KW_LATERAL KW_VIEW function_ tableAlias opt_450
    ...
    function_ ::= functionName LPAREN grp_559 RPAREN opt_567
