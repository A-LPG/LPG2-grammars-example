-- Real lexer for SqlDrillParser (not token-stream soup). Keywords via SqlDrillKWLexer.
%Options list
%Options fp=SqlDrillLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.sql.drill
%options template=LexerTemplateF.gi
%options filter=SqlDrillKWLexer.gi

%Define
    $kw_lexer_class /.$SqlDrillKWLexer./
%End
