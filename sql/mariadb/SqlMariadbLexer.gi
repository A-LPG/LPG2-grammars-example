-- Real lexer for SqlMariadbParser (not token-stream soup). Keywords via SqlMariadbKWLexer.
%Options list
%Options fp=SqlMariadbLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.sql.mariadb
%options template=LexerTemplateF.gi
%options filter=SqlMariadbKWLexer.gi

%Define
    $kw_lexer_class /.$SqlMariadbKWLexer./
%End
