-- Real lexer for StringtemplateParser (not token-stream soup). Keywords via StringtemplateKWLexer.
%Options list
%Options fp=StringtemplateLexer
%options single_productions
%options conflicts
%options package=lpg.grammars.stringtemplate
%options template=LexerTemplateF.gi
%options filter=StringtemplateKWLexer.gi

%Define
    $kw_lexer_class /.$StringtemplateKWLexer./
%End
